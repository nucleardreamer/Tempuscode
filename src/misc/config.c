...
room_num newbie_school_start_room = 301;
room_num newbie_tutorial_complete_start_room = 333;
...
int guild_donation_info[][4] = {
    ...
    {CLASS_BARD, ALL, HOME_MODRIAN, 3217},
